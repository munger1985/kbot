"""在开发 Oracle 上验收 Conversation Memory 的完整归并与清理链路。"""
        ...
        async with runtime.session_factory() as session:
            ...
            session.add(
                AgentDefinitionEntity(
                    ...
                    router_llm_model_name="memory-smoke-model",
                    context_llm_model_name="memory-smoke-model",
                    composer_llm_model_name="memory-smoke-model",
                    memory_llm_model_name="memory-smoke-model",
                    query_vlm_model_name=None,
                    memory_embedding_model_name=(
                        "memory-smoke-embedding"
                    ),
                    config_json={
                        "memory": {
