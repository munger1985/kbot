"""生成并校验 KBot 4.0 全部 HTTP 服务的 OpenAPI 快照。"""
...
def build_contracts() -> dict[str, dict[str, Any]]:
    ...
    from apps.agent_runtime_api.main import (  # noqa: PLC0415
        app as agent_runtime_app,
    )
    from apps.ai_models_embedding.main import (  # noqa: PLC0415
        app as embedding_app,
    )
    from apps.ai_models_llm.main import app as llm_app  # noqa: PLC0415
    from apps.ai_models_visual.main import (  # noqa: PLC0415
        app as visual_app,
    )
    from apps.ai_models_vlm.main import app as vlm_app  # noqa: PLC0415
    from apps.knowledge_core_api.main import (  # noqa: PLC0415
