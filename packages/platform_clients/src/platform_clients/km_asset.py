...
class KmAssetClient:
    ...
    async def batch_reindex_assets(self, *, payload: dict[str, Any], auth_context: AuthContext):
        return await self._json("POST", f"{self._BASE}/assets/actions/reindex", payload=payload, auth_context=auth_context)
