...
class KmAgentEntity(BaseEntity):
    __tablename__ = "KBOT_KM_AGENT"
    __table_args__ = (UniqueConstraint("domain_id", "display_name", name="UK_KM_AGENT_NAME"),)
...
class KmAgentVersionEntity(BaseEntity):
    __tablename__ = "KBOT_KM_AGENT_VERSION"
    __table_args__ = (UniqueConstraint("agent_id", "version_no", name="UK_KM_AGENT_VERSION"),)
