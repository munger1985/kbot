...
async def main() -> None:
    ...
    timeout = max(
        slack_config.main_api.timeout_seconds,
    ...
    try:
        dispatcher = SlackDispatchService(
            ...
            main_api_client=KmPortalClient(
                base_url=slack_config.main_api.base_url,
                api_key=slack_config.main_api.require_api_key(),
                timeout_seconds=slack_config.main_api.timeout_seconds,
