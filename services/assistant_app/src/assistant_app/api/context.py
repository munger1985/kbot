"""智能工作台内部 API 的共享鉴权与错误映射。"""

from fastapi import HTTPException, Request
from fastapi.responses import JSONResponse

from assistant_app.application import AgentApplicationError, AssistantApplicationError
...
def raise_application_error(exc: AgentApplicationError | AssistantApplicationError) -> None:
