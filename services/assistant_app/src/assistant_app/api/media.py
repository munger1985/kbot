...
from assistant_app.application import AssistantApplicationError, MediaAssetService


router = APIRouter(prefix="/internal/v1/assistant/media-assets", tags=["Assistant Media"])
