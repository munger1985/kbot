...
class MediaStudioModelBindingEntity(BaseEntity):
    __tablename__ = "KBOT_MEDIA_MODEL_BINDING"
    __table_args__ = (
        UniqueConstraint("domain_id", "role", name="UK_MEDIA_BINDING_ROLE"),
        Index("IX_MEDIA_BINDING_MODEL", "model_id"),
    )
...
class MediaStudioRunEntity(BaseEntity):
    __tablename__ = "KBOT_MEDIA_RUN"
    __table_args__ = (
        UniqueConstraint("domain_id", "actor_id", "idempotency_key", name="UK_MEDIA_RUN_IDEMP"),
        UniqueConstraint("run_id", "domain_id", name="UK_MEDIA_RUN_SCOPE"),
        Index("IX_MEDIA_RUN_DOMAIN_TIME", "domain_id", "created_at"),
        Index("IX_MEDIA_RUN_CLAIM", "status", "lease_until"),
    )
...
class MediaStudioRunEventEntity(BaseEntity):
    __tablename__ = "KBOT_MEDIA_RUN_EVENT"
    __table_args__ = (
        UniqueConstraint("run_id", "sequence_no", name="UK_MEDIA_RUN_EVENT_SEQ"),
    )
...
class MediaStudioPromptRevisionEntity(BaseEntity):
    __tablename__ = "KBOT_MEDIA_PROMPT_REVISION"
    __table_args__ = (
        Index("IX_MEDIA_PROMPT_RUN", "run_id"),
    )
...
class MediaStudioMediaAssetEntity(BaseEntity):
    __tablename__ = "KBOT_MEDIA_ASSET"
    __table_args__ = (
        Index("IX_MEDIA_ASSET_DOMAIN", "domain_id", "created_at"),
        Index("IX_MEDIA_ASSET_RUN", "run_id"),
    )
