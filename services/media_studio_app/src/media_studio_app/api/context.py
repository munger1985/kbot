"""多媒体创作工作台内部 API 的共享鉴权与错误映射。"""

from fastapi import HTTPException, Request
from fastapi.responses import JSONResponse

from media_studio_app.application import MediaStudioApplicationError
...
def require_actor(request: Request, domain_id: int) -> str:
    ...
    if not isinstance(identity, ServiceIdentity) or "media_studio.manage" not in identity.scopes:
...
def raise_application_error(exc: MediaStudioApplicationError) -> None:
