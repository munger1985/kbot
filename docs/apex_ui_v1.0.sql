...
Insert into KBOT_MD_DATA_DIC (APP_ID,NAME,DISPLAY_NAME,RETURN_VALUE,LANG_CODE,DISPLAY_TRAN_VALUE,STATUS,DESCS,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,IS_DEFAULT) values (112,'MODEL_CATEGORY','OCR','6','zh-cn','OCR',0,null,'ADMIN',to_date('08-7月 -25','DD-MON-RR'),'ADMIN',to_date('08-7月 -25','DD-MON-RR'),0);
