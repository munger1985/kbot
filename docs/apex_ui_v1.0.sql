...
Insert into KBOT_MD_DATA_DIC (APP_ID,NAME,DISPLAY_NAME,RETURN_VALUE,LANG_CODE,DISPLAY_TRAN_VALUE,STATUS,DESCS,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,IS_DEFAULT) values (112,'CHUNK_PARSER_TYPE','ROW','5','zh-cn','按行来拆分',1,null,'ADMIN',to_date('27-8月 -25','DD-MON-RR'),'ADMIN',to_date('27-8月 -25','DD-MON-RR'),0);
...
Insert into KBOT_MD_DATA_DIC (APP_ID,NAME,DISPLAY_NAME,RETURN_VALUE,LANG_CODE,DISPLAY_TRAN_VALUE,STATUS,DESCS,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,IS_DEFAULT) values (112,'FILE_STATUS','Archived','8','zh-cn','归档',1,null,'ADMIN',to_date('01-7月 -25','DD-MON-RR'),'ADMIN',to_date('18-8月 -25','DD-MON-RR'),0);
...
Insert into KBOT_MD_DATA_DIC (APP_ID,NAME,DISPLAY_NAME,RETURN_VALUE,LANG_CODE,DISPLAY_TRAN_VALUE,STATUS,DESCS,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,IS_DEFAULT) values (112,'MODEL_PROVIDER','OCIGenAI','oci','zh-cn','OCIGenAI',1,null,'ADMIN',to_date('20-8月 -25','DD-MON-RR'),'ADMIN',to_date('20-8月 -25','DD-MON-RR'),0);
Insert into KBOT_MD_DATA_DIC (APP_ID,NAME,DISPLAY_NAME,RETURN_VALUE,LANG_CODE,DISPLAY_TRAN_VALUE,STATUS,DESCS,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,IS_DEFAULT) values (112,'ACCESSOR_TYPE','kbot user','1','zh-cn','kbot用户',1,null,'ADMIN',to_date('04-9月 -25','DD-MON-RR'),'ADMIN',to_date('04-9月 -25','DD-MON-RR'),1);
Insert into KBOT_MD_DATA_DIC (APP_ID,NAME,DISPLAY_NAME,RETURN_VALUE,LANG_CODE,DISPLAY_TRAN_VALUE,STATUS,DESCS,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,IS_DEFAULT) values (112,'ACCESSOR_TYPE','kbot service','2','zh-cn','kbot服务',1,null,'ADMIN',to_date('04-9月 -25','DD-MON-RR'),'ADMIN',to_date('04-9月 -25','DD-MON-RR'),0);

Insert into KBOT_MD_PROMPT (APP_ID,DOMAIN_ID,NAME,PROMPT_CATEGORY,STATUS,DESCS,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,PROMPT_UNIQUE_NAME) values (112,161,'image2text',1,1,null,'ADMIN',to_date('13-8月 -25','DD-MON-RR'),'ADMIN',to_date('13-8月 -25','DD-MON-RR'),'SYSTEM/image2text');
Insert into KBOT_MD_PROMPT (APP_ID,DOMAIN_ID,NAME,PROMPT_CATEGORY,STATUS,DESCS,CREATED_BY,CREATED_TIME,UPDATED_BY,UPDATED_TIME,PROMPT_UNIQUE_NAME) values (112,null,'Common_CN',2,1,null,'ADMIN',to_date('13-8月 -25','DD-MON-RR'),'ADMIN',to_date('13-8月 -25','DD-MON-RR'),'TEMPLATE/Common_CN');
