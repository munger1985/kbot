...
from platform_core.config.settings import get_dsocr_config, detect_builtin_ocr_engines
from platform_core.dictionary import OCRProvider, OCR_ENGINE_LABELS
