...
cp configuration/config_manager.py microservices/synonym/ms_core/config_manager.py 
...
sed -i 's/from core.nacos_manager import nacos_manager/from .nacos_manager import nacos_manager/g' microservices/synonym/ms_core/config_manager.py
...
cp .env.example microservices/synonym/.env
