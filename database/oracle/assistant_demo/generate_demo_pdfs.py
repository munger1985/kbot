"""生成 Assistant App 问文 Demo 的中文 PDF 文档。"""
...
def build_document(*, filename: str, title: str, date: str, customer: str, attendees: str,
    ...
    document = SimpleDocTemplate(
        ...
        topMargin=16 * mm, bottomMargin=16 * mm, title=title, author="Assistant App Demo",
    )
    story = [
    ...
    story.extend([
        ...
        Spacer(1, 5 * mm),
        p("本文件为 Assistant App 知识库演示资料，内容为虚构的业务测试数据。沟通原文、需求解释和风险依据以本文件为准，CRM 中仅保留可统计的活动摘要。", styles["small"]),
    ])
