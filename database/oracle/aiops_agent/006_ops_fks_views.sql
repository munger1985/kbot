...
GROUP BY
    t.TARGET_ID, t.APP_ID, t.DOMAIN_ID, t.TARGET_KEY, t.DISPLAY_NAME,
    t.DB_TYPE, t.VERSION_CODE, t.ENVIRONMENT, t.DB_ROLE,
    t.EXECUTION_MODE, t.SECURITY_LEVEL, t.STATUS, t.HEALTH_STATUS,
...
LEFT JOIN KBOT_OPS_TARGET_MONITOR tm
   ...
   AND tm.STATUS = 'ACTIVE'
GROUP BY
    m.MONITOR_SOURCE_ID, m.APP_ID, m.DOMAIN_ID, m.SOURCE_KEY,
