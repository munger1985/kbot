...
class KbotSysParserConf(Base):
    """System configuration entity for KBOT_SYS_PARSER_CONF table."""
    ...
    is_default: Mapped[int | None] = mapped_column(Numeric(1, 0), comment="是否为默认配置：1-是，0-否")
