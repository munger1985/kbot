...
from tests.acceptance.check_aiops_entity_schema import entity_column_contract
from tests.acceptance.check_oracle_entity_schema import _entity_classes
...
class OracleEntitySchemaCheckerTest(unittest.TestCase):
    ...
    def test_vector_columns_use_vector_family(self) -> None:
        ...
        self.assertEqual(71, contracts.count("JSON"))
