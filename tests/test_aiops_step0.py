...
from apps.aiops_api.main import app as aiops_api_app
from apps.aiops_db_executor.main import app as executor_app
from apps.aiops_scheduler.main import app as scheduler_app
from apps.aiops_worker.main import app as worker_app
