"""实库验收五个服务全部 SQLAlchemy Entity 与当前 Oracle 列契约。"""
...
from tests.acceptance.check_aiops_entity_schema import (  # noqa: E402
    ColumnContract,
    catalog_column_contract,
    entity_column_contract,
)
from tests.acceptance.check_entity_ownership import ENTITY_MODULES  # noqa: E402
