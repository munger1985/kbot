...
import media_studio_app.entities as media_entities  # noqa: E402
...
ENTITY_MODULES = {
    ...
    "media_studio_app": media_entities,
...
def main() -> int:
    ...
    print(
        f"KBot Entity 所有权校验通过：{len(SERVICE_TABLES)} 个服务，"
        f"{count} 张表"
    )
    return 0
