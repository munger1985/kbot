...
class KBotKB(Base):
    ...
    vectordb_type: Mapped[str] = mapped_column(String(256))
    embed_model: Mapped[str] = mapped_column(String(256))
    kb_status: Mapped[str] = mapped_column(String(256))
    upload_file_cnt: Mapped[int] = mapped_column(BigInteger)
    approved_file_cnt: Mapped[int] = mapped_column(BigInteger)
    parsed_file_cnt: Mapped[int] = mapped_column(BigInteger)
